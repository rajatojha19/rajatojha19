...
### 🥔 PotatoDetection
Computer vision model for potato disease detection using deep learning. Achieved high accuracy in classifying healthy vs. diseased potatoes.
- **Tech:** Python, TensorFlow, OpenCV, Jupyter
- **Key Feature:** CNN-based classification model
- [View Repository](https://github.com/rajatojha19/PotatoDetection)

### 📊 VOIS_AICTE_Oct2025_Rajat-Ojha
Advanced machine learning project developed as part of VOIS AICTE training program. Focused on data science fundamentals and predictive modeling.
